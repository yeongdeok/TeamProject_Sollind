			...
			<td>		
				<table id="bestBoarder">
					...
					<c:forEach var="boardBest" items="${boards }" begin="0" end="9">
						<tr>
							<td id="boardBestType">
								<a href="/goBoardHome?type=${boardBest.b_type }">${boardBest.b_type }</a>
							</td>
						 	...
						 	<table class="boardPartTableLeft">
						 		<tr>
						 			<td class="boardPartTitle">
						 				...
						 				<a class="boardPartMore" href="/goBoardHome?type=자유게시판">
						 				더보기 >
						 				</a>
						 			</td>
						 		</tr>
						 	...
						 	<table class="boardPartTableRight">
						 		<tr>
						 			<td class="boardPartTitle">
						 				...
						 				<a class="boardPartMore" href="/goBoardHome?type=이직·커리어">
						 				더보기 >
						 				</a>
						 			</td>
						 		</tr>
						 	...
						 	<table class="boardPartTableLeft">
						 		<tr>
						 			<td class="boardPartTitle">
						 				...
						 				<a class="boardPartMore" href="/goBoardHome?type=헬스">
						 				더보기 >
						 				</a>
						 			</td>
						 		</tr>
						 	...
						 	<table class="boardPartTableRight">
						 		<tr>
						  			<td class="boardPartTitle">
						 				...
						 				<a class="boardPartMore" href="/goBoardHome?type=회사생활">
						 				더보기 >
						 				</a>
						 			</td>
						 		</tr>
						 	...
						 	<table class="boardPartTableLeft">
						 		<tr>
						 			<td class="boardPartTitle">
						 				...
						 				<a class="boardPartMore" href="/goBoardHome?type=여행">
						 				더보기 >
						 				</a>
						 			</td>
						 		</tr>
						 	...
						 	<table class="boardPartTableRight">
						 		<tr>
						 			<td class="boardPartTitle">
						 				...
						 				<a class="boardPartMore" href="/goBoardHome?type=알쓸신잡">
						 				더보기 >
						 				</a>
						 			</td>
						 		</tr>
						 	...
						 	<table class="boardPartTableLeft">
						 		<tr>
						 			<td class="boardPartTitle">
						 				...
						 				<a class="boardPartMore" href="/goBoardHome?type=연애">
						 				더보기 >
						 				</a>
						 			</td>
						 		</tr>
						 	...
						 	<table class="boardPartTableRight">
						 		<tr>
						 			<td class="boardPartTitle">
						 				...
						 				<a class="boardPartMore" href="/goBoardHome?type=스포츠">
						 				더보기 >
						 				</a>
						 			</td>
						 		</tr>
