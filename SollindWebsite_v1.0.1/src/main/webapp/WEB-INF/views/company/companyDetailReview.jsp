...
<script type="text/javascript" src="resources/js/companyJS/companyDetailReview.js"></script>
</head>
<body>
	<table id="homeTable">
		<tr>
								...
								<tr>
									<td align="right" style="padding: 10px;">
										<c:if test="${cr.cr_m_id == sessionScope.loginMember.m_id }">
											<button id="companyShowReviewDeleteBtn" onclick="realDeleteReview(${companyInfo.c_no}, ${cr.cr_no });">삭제</button>
										</c:if>
									</td>
								</tr>
							</table>
